...
@objc public enum LayoutBaselineType: Int {
    case top
    case center
    case bottom
}
...
public class CenteredFlowLayout: UICollectionViewFlowLayout {
    ...
    var itemScale: CGFloat = 0.7

    var itemAlpha: CGFloat = 0.7

    var itemSpacing: CGFloat = 15

    var sideItemBaselineType = LayoutBaselineType.center
    ...
    fileprivate func updateLayout() {
        ...
        let scaledItemOffset = (scrollDirectionItemWidth - scrollDirectionItemWidth * self.itemScale) / 2
    ...
    fileprivate func transformLayoutAttributes(_ attributes: UICollectionViewLayoutAttributes) -> UICollectionViewLayoutAttributes {
        ...
        let scale = ratio * (1 - self.itemScale) + self.itemScale
        ...
        case .top:
            sideItemFixedOffset = -(scrollDirectionItemHeight - scrollDirectionItemHeight * self.itemScale) / 2
        case .center:
            sideItemFixedOffset = 0
        case .bottom:
            sideItemFixedOffset = (scrollDirectionItemHeight - scrollDirectionItemHeight * self.itemScale) / 2
        }
        let shift = (1 - ratio) * (itemOffset + sideItemFixedOffset)
        if isHorizontal {
